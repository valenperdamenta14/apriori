      ...
      <section className="py-20 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
              title: "Upload Data",
              desc: "Mengunggah data diagnosa dan obat dari klinik.",
            },
            {
              title: "Proses Apriori",
              desc: "Mengolah data menggunakan algoritma Apriori untuk menemukan pola.",
            },
            {
              title: "Visualisasi Hasil",
              desc: "Menampilkan hasil analisis dalam bentuk grafik dan tabel.",
            },
          ].map((item, index) => (
            <div
              key={index}
